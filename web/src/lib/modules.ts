...
export type ModuleKey =
  "mail" | "drive" | "contacts" | "chat" | "passwords" | "ai" | "workflow";
...
export const NAV_TREE: NavNode[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        labelKey: "nav.contacts.groups",
        to: "/contacts?view=groups",
        icon: Boxes,
      },
    ],
  },
  ...
  },
  {
    ...
    children: [
      ...
      {
        labelKey: "nav.passwords.folders",
        to: "/passwords?view=folders",
        icon: Folder,
      },
    ],
  },
  ...
  },
  {
    ...
    children: [
      ...
      {
        labelKey: "nav.workflow.runs",
        to: "/workflow?view=runs",
        icon: Activity,
      },
    ],
  },
...
export const ADMIN_NAV_GROUPS: AdminNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      {
        labelKey: "dashboard.modules.mail.label",
        to: "/admin/modules/mail",
        icon: Mailbox,
      },
      {
        labelKey: "dashboard.modules.drive.label",
        to: "/admin/modules/drive",
        icon: Cloud,
      },
      {
        labelKey: "dashboard.modules.contacts.label",
        to: "/admin/modules/contacts",
        icon: Contact,
      },
      {
        labelKey: "dashboard.modules.chat.label",
        to: "/admin/modules/chat",
        icon: MessagesSquare,
      },
      {
        labelKey: "dashboard.modules.passwords.label",
        to: "/admin/modules/passwords",
        icon: KeyRound,
      },
      {
        labelKey: "dashboard.modules.ai.label",
