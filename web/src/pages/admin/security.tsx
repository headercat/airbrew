...
export default function AdminSecurity() {
  ...
  const refresh = useCallback(async () => {
    try {
      const res = await api.get<{ sessions: AdminSession[] }>(
        "/api/admin/sessions",
      );
      ...
      <Card>
        ...
        <CardContent className="divide-y divide-border p-0">
          ...
          <SettingRow
            ...
            description={t("admin.security.comingSoon")}
          >
            <Switch disabled />
          </SettingRow>
          <SettingRow
            title={t("admin.security.sessionTimeout")}
            description={t("admin.security.comingSoon")}
          >
            <Badge variant="outline">14d</Badge>
          </SettingRow>
          <SettingRow
            title={t("admin.security.ipAllowlist")}
            description={t("admin.security.comingSoon")}
          >
            <Switch disabled />
          </SettingRow>
