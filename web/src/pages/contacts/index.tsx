...
function contactToForm(contact: ContactRecord | null): ContactFormState {
...
function formToPayload(form: ContactFormState): ContactPayload {
  return {
...
function subtitle(contact: ContactRecord) {
  return (
